...
const Icon = (() => {
  const P = {
    ...
    chevronArriba: '<path d="m18 15-6-6-6 6"/>',
    ...
    luna: '<path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9"/>',
    /* Círculo medio relleno: "lo que diga el sistema". El relleno se hace con
       un trazo grueso a media caña, para no romper la regla de solo-trazo. */
    contraste: '<circle cx="12" cy="12" r="9"/><path d="M12 3a9 9 0 0 0 0 18"/><path d="M12 5.2a6.8 6.8 0 0 0 0 13.6" stroke-width="4.6"/>',

    /* --- Administración --------------------------------------------------- */
    admin: '<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><circle cx="12" cy="10" r="2.1"/><path d="M8.8 16.4a3.6 3.6 0 0 1 6.4 0"/>',
    llaveMaestra: '<circle cx="8" cy="15" r="4"/><path d="m10.85 12.15 8.4-8.4"/><path d="m16.5 6.5 2.5 2.5"/><path d="m19.5 3.5 1.5 1.5"/>',
    bloqueado: '<rect width="16" height="10" x="4" y="12" rx="2"/><path d="M8 12V8a4 4 0 0 1 8 0v4"/><path d="M12 16v2"/>',
    ojoRevision: '<path d="M2.06 12.35a1 1 0 0 1 0-.7 10.75 10.75 0 0 1 19.88 0 1 1 0 0 1 0 .7 10.75 10.75 0 0 1-19.88 0"/><circle cx="12" cy="12" r="3"/><path d="M12 2v2"/>',

    /* --- Paleta de comandos ----------------------------------------------- */
    comando: '<path d="M15 6v12a3 3 0 1 0 3-3H6a3 3 0 1 0 3 3V6a3 3 0 1 0-3 3h12a3 3 0 1 0-3-3"/>',
    teclado: '<rect width="20" height="14" x="2" y="5" rx="2"/><path d="M6 9h.01M10 9h.01M14 9h.01M18 9h.01M8 13h8"/>',
    retorno: '<path d="M9 10 4 15l5 5"/><path d="M20 4v7a4 4 0 0 1-4 4H4"/>',

    /* --- Utilidades ------------------------------------------------------- */
    abrirFuera: '<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',
    copiar: '<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',
    hojaCalculo: '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/>',
